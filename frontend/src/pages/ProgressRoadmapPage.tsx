...
const progressAreas: ProgressArea[] = [
  ...
  },
  {
    ...
    percent: 55,
    status: 'in-progress',
    summary: '説明欄・写真・販売者評価・手動補正ルールを使って、ユーザー知見をあとから反映できる土台を追加しました。',
    done: ['推薦スコア再計算', 'S/A/B/C/NGランク表示', '仕入れ/要確認/見送り保存', 'CSV出力', '説明欄/写真/販売者評価リスク', '手動補正ルールAPI'],
    remaining: ['実画像解析', '仕入れ実績からの自動ルール候補', '見送り理由の分析', '利益予測モデル', '画面からの補正ルール管理'],
  },
  {
    title: 'CI / Operations',
    percent: 50,
